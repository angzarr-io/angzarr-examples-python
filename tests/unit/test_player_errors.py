...
@pytest.mark.parametrize(
    ...
    [
        (PlayerAlreadyExists(), "PLAYER_ALREADY_EXISTS", "FAILED_PRECONDITION",
         "Player already exists"),
        (DisplayNameRequired(), "DISPLAY_NAME_REQUIRED", "INVALID_ARGUMENT",
         "display_name is required"),
        (EmailRequired(), "EMAIL_REQUIRED", "INVALID_ARGUMENT",
         "email is required"),
        (PlayerNotFound(), "PLAYER_NOT_FOUND", "FAILED_PRECONDITION",
         "Player does not exist"),
        (AmountMustBePositive(value=-5), "AMOUNT_MUST_BE_POSITIVE", "INVALID_ARGUMENT",
         "Amount must be positive, got -5"),
        (AmountMustBeNonZero(value=0), "AMOUNT_MUST_BE_NON_ZERO", "INVALID_ARGUMENT",
         "Amount must be non-zero"),
        (InsufficientAvailableBalance(requested=500, available=100),
         "INSUFFICIENT_AVAILABLE_BALANCE", "FAILED_PRECONDITION",
        ...
        (FundsAlreadyReservedForTable(table_root_hex="abc123"),
         "FUNDS_ALREADY_RESERVED_FOR_TABLE", "FAILED_PRECONDITION",
         "Funds already reserved for table abc123"),
        (TableRootRequired(), "TABLE_ROOT_REQUIRED", "INVALID_ARGUMENT",
         "table_root is required"),
        (NoFundsReservedForTable(table_root_hex="abc123"),
         "NO_FUNDS_RESERVED_FOR_TABLE", "FAILED_PRECONDITION",
         "No funds reserved for table abc123"),
        (KeyRequired(), "KEY_REQUIRED", "INVALID_ARGUMENT",
         "key is required"),
        (AmountExceedsReservedFunds(requested=300, available=100),
         "AMOUNT_EXCEEDS_RESERVED_FUNDS", "FAILED_PRECONDITION",
