...
_runtime_version.ValidateProtobufRuntimeVersion(
    _runtime_version.Domain.PUBLIC, 5, 28, 3, "", "angzarr/query.proto"
)
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_EVENTQUERYSERVICE"].methods_by_name[
        "GetEventBook"
    ]._loaded_options = None
    _globals["_EVENTQUERYSERVICE"].methods_by_name[
        "GetEventBook"
    ]._serialized_options = (
        b"\202\323\344\223\002!\022\037/v1/query/{cover.domain}/events"
    )
    _globals["_EVENTQUERYSERVICE"].methods_by_name["GetEvents"]._loaded_options = None
    _globals["_EVENTQUERYSERVICE"].methods_by_name[
        "GetEvents"
    ]._serialized_options = (
        b"\202\323\344\223\002(\022&/v1/query/{cover.domain}/events/stream"
    )
    _globals["_EVENTQUERYSERVICE"].methods_by_name[
        "GetAggregateRoots"
    ]._loaded_options = None
    _globals["_EVENTQUERYSERVICE"].methods_by_name[
        "GetAggregateRoots"
    ]._serialized_options = b"\202\323\344\223\002\026\022\024/v1/query/aggregates"
