...
from angzarr import projector_pb2 as angzarr_dot_projector__pb2
...
def add_ProjectorServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('angzarr.ProjectorService', rpc_method_handlers)
...
def add_ProjectorCoordinatorServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('angzarr.ProjectorCoordinatorService', rpc_method_handlers)
