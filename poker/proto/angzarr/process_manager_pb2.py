...
_runtime_version.ValidateProtobufRuntimeVersion(
    _runtime_version.Domain.PUBLIC, 5, 28, 3, "", "angzarr/process_manager.proto"
)
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals[
        "_PROCESSMANAGERHANDLEREQUEST_DESTINATIONSEQUENCESENTRY"
    ]._loaded_options = None
    _globals[
        "_PROCESSMANAGERHANDLEREQUEST_DESTINATIONSEQUENCESENTRY"
    ]._serialized_options = b"8\001"
    _globals["_PROCESSMANAGERCOORDINATORSERVICE"].methods_by_name[
        "Handle"
    ]._loaded_options = None
    _globals["_PROCESSMANAGERCOORDINATORSERVICE"].methods_by_name[
        "Handle"
    ]._serialized_options = b'\202\323\344\223\002\022"\r/v1/pm/handle:\001*'
    _globals["_PROCESSMANAGERCOORDINATORSERVICE"].methods_by_name[
        "HandleSpeculative"
    ]._loaded_options = None
    _globals["_PROCESSMANAGERCOORDINATORSERVICE"].methods_by_name[
        "HandleSpeculative"
    ]._serialized_options = b'\202\323\344\223\002\027"\022/v1/pm/speculative:\001*'
